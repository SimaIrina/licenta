...
INSERT INTO Appointment(`DATE`, `TIME`, DESCRIPTION, ROOM, STATUS, DOCTOR_ID, INVOICE_ID, PATIENT_ID) VALUES ('2015-08-09', '2:00PM', 'Durere de dinti', '200', 'NEW', 1, 1, 1);
INSERT INTO Appointment(`DATE`, `TIME`, DESCRIPTION, ROOM, STATUS, DOCTOR_ID, INVOICE_ID, PATIENT_ID) VALUES ('2015-08-10', '2:00PM', 'Obraz umflat', '300', 'NEW', 2, 2, 1);
INSERT INTO Appointment(`DATE`, `TIME`, DESCRIPTION, ROOM, STATUS, DOCTOR_ID, INVOICE_ID, PATIENT_ID) VALUES ('2015-08-16', '2:00PM', 'Nevoie albire dinti', '400', 'NEW', 1, 3, 1);
INSERT INTO Appointment(`DATE`, `TIME`, DESCRIPTION, ROOM, STATUS, DOCTOR_ID, INVOICE_ID, PATIENT_ID) VALUES ('2015-08-16', '2:00PM', 'Durere in gat', '500', 'NEW', 2, 4, 1);
INSERT INTO Appointment(`DATE`, `TIME`, DESCRIPTION, ROOM, STATUS, DOCTOR_ID, INVOICE_ID, PATIENT_ID) VALUES ('2015-08-16', '2:00PM', 'Nevoie extractie canin stang', '600', 'NEW', 1, 5, 1);